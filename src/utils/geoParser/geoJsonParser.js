...
const DISTRICTS = [
    {id: 1, name: 'Криворізька міська громада'},
    {id: 2, name: 'Софіївська селищна громада'},
    {id: 3, name: 'Лозуватська сільська громада'},
    {id: 4, name: 'Апостолівська міська громада'},
    {id: 5, name: 'Грушівська сільська громада'},
    {id: 6, name: 'Глеюватська сільська громада'},
    {id: 7, name: 'Новопільська сільська громада'},
    {id: 8, name: 'Вакулівська сільська громада'},
    {id: 9, name: 'Девладівська сільська громада'},
    {id: 10, name: 'Нивотрудівська сільська громада'},
    {id: 11, name: 'Зеленодольська міська громада'},
    {id: 12, name: 'Гречаноподівська сільська громада'},
    {id: 13, name: 'Широківська селищна громада'},
    {id: 14, name: 'Карпівська сільська громада'},
    {id: 15, name: 'Новолатівська сільська громада'}
];
