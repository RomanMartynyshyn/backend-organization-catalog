...
router.get('/',
  ...
  // Фільтр за адміністративною одиницею (ADMIN_UNITS): район міста або ОТГ.
  // Раніше було districtId, замінено на adminUnitId.
  query('adminUnitId').optional()
      .toArray()
      .isArray().withMessage('adminUnitId має бути масивом'),
  query('adminUnitId.*').isInt({ min: 1 }).withMessage('adminUnitId має бути цілим додатним числом'),
